package com.cutter.point.blog.zuul.vo;
...
public class ZuulRouteVO {
    ...
    public String toString() {
        ...
        sb.append("  serviceId="+this.getServiceId());
        sb.append("  url="+this.getUrl());
        sb.append("  retryable="+this.getRetryable());
        sb.append("  stripPrefix="+this.isStripPrefix());
        return sb.toString();
